...
const Gestures= () => {
  ...
  const handleBack=async()=>{
    navigate(-1);
    const res = await axios.get('http://localhost:5000/stop/hand-gesture');
  ...
  const handleMonitorClick = async () => {
    ...
    axios.get('http://localhost:5000/video/hand-gesture');
          ...
          <div className="p-8">
            ...
            {isMonitoring && (
               ...
               <div className="relative bg-gray-200 rounded-lg shadow-md w-[643px] h-[482px]" style={{ paddingTop: "56.25%" }}>
                 <iframe
                   src="http://localhost:5000/video/hand-gesture"
